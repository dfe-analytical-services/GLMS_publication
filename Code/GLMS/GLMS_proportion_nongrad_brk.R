...
pt_proport_breakdown<-function(quarter,year){
  ...
  #3.1 ----Graduate type: select Non Grads and include everyone that works full-time (FTWK) and part-time (PTWK)---------
  ...
  #combines all the Non Grad FTPTWK breakdowns in a table
