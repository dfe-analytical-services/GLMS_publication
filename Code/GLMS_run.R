### Installing/loading packages here
## Analyst for 2022: Sophie Holt ( + Mark Walsh + Steve White )
...
library("matrixStats")
#----Introduction----
# 2023 - the priority statistics policy support team are updating the code for the 2022 publication
...
source("Code/GLMS/GLMS_Recode_Variables2.R")
...
end_year = 2022 #Which year do you want the LFS data up to?
filepath <- "./GLMS 2022v1/"

#2.1---- Convert SPSS datasets to R:output ----

#Convert all LFS data from Q1 of the start year to Q4 of the end year into R data format (RDS)
...
#1.2.---- csv datasets to R data----
## 2022 note: you should not need to do this, but keeping it in for future reference.
...
#3.Outputs:analysis  -----
# Clean the data
source("Code/GLMS/GLMS_clean_data2.R")

# Add deflators and recalculate real weekly salaries with base as current year
source("Code/GLMS/GLMS_inflation.R")
